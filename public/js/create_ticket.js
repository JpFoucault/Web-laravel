/**
 * create_ticket.js — Validation du formulaire de création de ticket
 *
 * But : vérifier côté client que tous les champs obligatoires du formulaire
 * de création d'un ticket sont remplis avant d'envoyer la requête au serveur.
 *
 * Champs validés :
 *  - Titre       : non vide
...
// Sélectionne le formulaire de création de ticket
